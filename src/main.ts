...
class JobKhojApp {
 ...
 private async init(): Promise<void> {
  ...
  public async handleRouting(): Promise<void> {
    ...
    } else if (['about','contact','privacy-policy','terms','disclaimer','editorial-policy'].includes(hash)) {
      this.renderInformationPage(hash);
    } else {
      this.renderNotFoundView();
    }
    this.rewriteInternalLinks();
    this.activateSponsorSlots();
  ...
  private updateRouteSEO(route: string): void {
    ...
    link.href=canonical;
    const titles:Record<string,string>={home:f.seoSiteTitle,jobs:`Latest Jobs | ${f.seoSiteTitle}`,exams:`Competitive Exams | ${f.seoSiteTitle}`,results:`Results | ${f.seoSiteTitle}`,'admit-cards':`Admit Cards | ${f.seoSiteTitle}`,blog:`Job News & Career Blog | ${f.seoSiteTitle}`,about:`About Us | ${f.seoSiteTitle}`,contact:`Contact Us | ${f.seoSiteTitle}`,'privacy-policy':`Privacy Policy | ${f.seoSiteTitle}`,terms:`Terms & Conditions | ${f.seoSiteTitle}`,disclaimer:`Disclaimer | ${f.seoSiteTitle}`,'editorial-policy':`Editorial Policy | ${f.seoSiteTitle}`};
  ...
  private renderInformationPage(page: string): void {
    this.renderPublicLayout();
    ...
    const emailHtml = email
      ...
      : `<span>Use the support/contact details configured on this website.</span>`;

    const pages: Record<string, { title: string; intro: string; body: string }> = {
      about: {
        title: 'About Us',
        intro: 'Job Khoj is an independent Indian job-information platform that helps visitors discover recruitment updates, examinations, results and admit-card information in one place.',
        body: `
          <h2>What Job Khoj provides</h2>
          <p>We organize publicly available recruitment information into easier-to-read summaries, including important dates, vacancies, qualifications, age limits, application fees, selection processes and official links when available.</p>
          <p>Our goal is to make recruitment information easier to understand and navigate. Job Khoj is not a recruiting authority, government department, examination board or employer unless a page explicitly states otherwise.</p>
          <h2>Verification matters</h2>
          <p>Recruitment rules, dates, vacancies and application procedures can change. Visitors should always verify the latest details in the official notification and on the official organization website before applying or making a payment.</p>
          <h2>Editorial approach</h2>
          <p>We aim to publish clear, useful and reviewed information rather than simply reproducing another website's content. Where information comes from an official notification, the relevant official source is linked so visitors can verify it.</p>`
      },
      contact: {
        title: 'Contact Us',
        intro: 'If you find an incorrect recruitment detail, broken link, outdated notice or another issue on Job Khoj, please contact the site support team.',
        body: `
          <h2>Support</h2>
          <p>Email: ${emailHtml}</p>
          <p>Please include the page URL and a short description of the issue. For recruitment decisions, application status, fees, admit cards or official corrections, please also contact the recruiting organization directly.</p>
          <h2>Content corrections</h2>
          <p>We welcome factual corrections. We may review a correction against the official notification or official organization website before updating a page.</p>`
      },
      'privacy-policy': {
        title: 'Privacy Policy',
        intro: 'This Privacy Policy explains how Job Khoj may handle information when you visit or use this website.',
        body: `
          <h2>Information we may collect</h2>
          <p>Depending on the features you use, the website may process technical information such as IP address, browser/device information, approximate location derived from network information, pages viewed, referring pages and timestamps. If you contact us, we may also receive the information you choose to provide.</p>
          <h2>Cookies and local storage</h2>
          <p>Job Khoj may use cookies, browser storage or similar technologies to remember preferences, improve performance, maintain sessions and support analytics or advertising.</p>
          <h2>Advertising and third-party services</h2>
          <p>Job Khoj may use third-party advertising services, including Google AdSense if enabled and other advertising providers. These providers may use cookies or similar technologies to deliver, measure or personalize advertising in accordance with their own policies and applicable law.</p>
          <h2>Analytics and security</h2>
          <p>We may collect aggregated usage information to understand site performance and improve navigation. Security logs and technical information may be used to prevent abuse, fraud and unauthorized access.</p>
          <h2>External links</h2>
          <p>Our pages may link to official government, examination, employer or other third-party websites. Their privacy practices are governed by their own policies, not this Privacy Policy.</p>
          <h2>Your choices</h2>
          <p>You can control cookies through your browser settings and, where applicable, through consent or privacy controls presented by advertising or analytics providers.</p>
          <h2>Contact</h2>
          <p>For privacy questions, contact Job Khoj support: ${emailHtml}</p>`
      },
      terms: {
        title: 'Terms & Conditions',
        intro: 'By using Job Khoj, you agree to use the website responsibly and to verify important recruitment information with the relevant official source.',
        body: `
          <h2>Information service</h2>
          <p>Job Khoj provides recruitment and examination information for general informational purposes. We do not guarantee employment, selection, admission, examination results or acceptance of an application.</p>
          <h2>Official verification</h2>
          <p>Visitors are responsible for checking the official notification and official organization website for the latest eligibility rules, dates, fees, vacancies, documents and application instructions.</p>
          <h2>External websites</h2>
          <p>Links to external websites are provided for convenience. Job Khoj does not control those websites and is not responsible for their content, availability, transactions or privacy practices.</p>
          <h2>Acceptable use</h2>
          <p>You must not misuse the website, attempt unauthorized access, interfere with site operation, introduce malicious code or use the website for unlawful activity.</p>
          <h2>Changes</h2>
          <p>We may update website content, features and these terms when necessary. Continued use of the website after an update means you accept the updated terms.</p>`
      },
      disclaimer: {
        title: 'Disclaimer',
        intro: 'Job Khoj is an independent information platform and is not a recruiting authority unless explicitly stated on a specific page.',
        body: `
          <h2>Accuracy and updates</h2>
          <p>We make reasonable efforts to present recruitment information clearly, but vacancies, eligibility, dates, fees, age limits, selection processes and application procedures may change or contain errors.</p>
          <p>Always verify information against the latest official notification and the official website of the recruiting organization before taking action.</p>
          <h2>No employment guarantee</h2>
          <p>Publishing a vacancy or recruitment update on Job Khoj does not mean that Job Khoj is the employer, recruiting agency or examination authority.</p>
          <h2>Payments and applications</h2>
          <p>Job Khoj does not collect recruitment application fees unless a page explicitly states otherwise. Applications and payments should be completed through the official portal of the relevant organization.</p>
          <h2>Third-party links</h2>
          <p>External links may lead to official or third-party websites. Users should review the destination website before submitting personal information or payment.</p>`
      },
      'editorial-policy': {
        title: 'Editorial Policy',
        intro: 'Our editorial goal is to make recruitment information useful, understandable and easy to verify.',
        body: `
          <h2>Source-first publishing</h2>
          <p>Recruitment pages should be based on an identifiable source, preferably the official notification or official organization website. Important claims such as dates, vacancies, eligibility and fees should be checked against the source available to us.</p>
          <h2>Original value</h2>
          <p>Job Khoj aims to add value through structured summaries, explanations, categorization, important-date tables and direct official links instead of simply copying another publisher's page.</p>
          <h2>Corrections and updates</h2>
          <p>If an official organization changes a recruitment notice, we may update the corresponding Job Khoj page. Visitors can report errors through the Contact Us page.</p>
          <h2>Advertising separation</h2>
          <p>Advertising should remain distinguishable from editorial recruitment information. Advertisements do not determine our editorial content.</p>`
      }
    };

    const selected = pages[page] || pages.about;
    main.innerHTML = `
      <article class="container section-padding info-page">
        <div class="directory-header">
          <h1 class="directory-title">${selected.title}</h1>
          <p class="directory-subtitle">${selected.intro}</p>
        </div>
        <div class="info-page-card">
          ${selected.body}
          <p class="info-page-updated">Last reviewed: ${new Date().toLocaleDateString('en-IN', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
        </div>
      </article>`;
  }
  ...
  // Direct sponsor renderer. Sponsor code is isolated in a sandboxed iframe so trusted admin
  // HTML/CSS can be displayed without allowing sponsor JavaScript to execute in the main page.
  private renderSponsorTop(customClass = ''): string {
    const ad = JobKhojDataStore.getAdSlots().find(a => a.id === 'sponsor-top');
    if (!ad || !ad.enabled || !ad.htmlContent.trim()) return '';
    const encoded = this.encodeAdCode(ad.htmlContent);
    return `<section class="sponsor-top-slot ${this.escapeHtml(customClass)}" aria-label="Sponsored">` +
      `<div class="sponsor-top-label">Sponsored</div>` +
      `<iframe class="sponsor-top-frame" title="Sponsored content" sandbox="allow-popups allow-popups-to-escape-sandbox" data-sponsor-code="${encoded}" loading="lazy"></iframe>` +
      `</section>`;
  }
  ...
  private activateSponsorSlots(): void {
    document.querySelectorAll<HTMLIFrameElement>('.sponsor-top-frame[data-sponsor-code]').forEach(frame => {
      if (frame.dataset.sponsorLoaded === '1') return;
      const code = frame.dataset.sponsorCode || '';
      if (!code) return;
      try {
        const html = this.decodeAdCode(code);
        frame.srcdoc = `<!doctype html><html><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><style>html,body{margin:0;padding:0;width:100%;min-height:100%;overflow:hidden}body{box-sizing:border-box}</style></head><body>${html}</body></html>`;
        frame.dataset.sponsorLoaded = '1';
      } catch (error) {
        console.error('Sponsor code failed to load', error);
      }
    });
  }
          ...
          <div class="footer-top-grid">
            ...
            <div>
              ...
              <ul class="footer-links-list">
                ...
                <li class="footer-link-item"><a href="/terms">Terms &amp; Conditions</a></li>
                <li class="footer-link-item"><a href="/disclaimer">Disclaimer</a></li>
                <li class="footer-link-item"><a href="/editorial-policy">Editorial Policy</a></li>
              </ul>
            </div>
          </div>
  ...
  private renderAdminAds(container: HTMLElement): void {
    ...
    const sponsor = ads.find(a => a.id === 'sponsor-top') || { id:'sponsor-top', title:'Direct Sponsor — Top of public pages', locationName:'Sponsor Top', htmlContent:'', enabled:false };
    const sponsorCard = `
      <section class="sponsor-admin-card">
        <div class="adsterra-unit-head">
          <div>
            <div class="adsterra-unit-name">Direct Sponsorship — Top Banner</div>
            <div class="adsterra-unit-meta"><span>Code based</span><span>Top of public pages</span><span>Sponsored label</span></div>
          </div>
          <label class="adsterra-switch">
            <input type="checkbox" id="sponsor-enable" ${sponsor.enabled ? 'checked' : ''}>
            <span></span><b>${sponsor.enabled ? 'Active' : 'Inactive'}</b>
          </label>
        </div>
        <div class="adsterra-code-row">
          <div class="adsterra-code-label"><label for="sponsor-code">SPONSOR CODE</label><span class="${sponsor.htmlContent.trim() ? 'adsterra-code-state-ready' : 'adsterra-code-state-empty'}">${sponsor.htmlContent.trim() ? 'Code saved' : 'No code yet'}</span></div>
          <textarea id="sponsor-code" class="admin-form-textarea adsterra-code-textarea" rows="8" spellcheck="false" placeholder="Paste sponsor HTML/CSS code here. JavaScript is disabled inside the sponsor sandbox.">${this.escapeHtml(sponsor.htmlContent)}</textarea>
        </div>
        <div class="adsterra-unit-footer"><span>Use HTML/CSS and a normal sponsor link. JavaScript is intentionally blocked for safety.</span><span>Placement: Top of public pages</span></div>
      </section>`;
    ...
    container.innerHTML = `
      <div class="adsterra-admin-page">
        <div class="admin-view-header">
          <div>
            <h1 class="admin-heading">Advertisement System</h1>
            <p class="admin-subheading">Manage Adsterra units and direct sponsor placements from one panel.</p>
          </div>
    ...
    document.getElementById('admin-ads-form')?.addEventListener('submit', async (e) => {
      ...
      const sponsorCode = (document.getElementById('sponsor-code') as HTMLTextAreaElement | null)?.value ?? sponsor.htmlContent ?? '';
      const sponsorEnabled = (document.getElementById('sponsor-enable') as HTMLInputElement | null)?.checked ?? sponsor.enabled ?? false;
      const updatedAds: AdSlot[] = [{ id:'sponsor-top', title:'Direct Sponsor — Top of public pages', locationName:'Sponsor Top', htmlContent:sponsorCode, enabled:sponsorEnabled }, ...Object.entries(ADSTERRA_UNITS).map(([slotId, unit]) => {
      ...
      try {
        ...
        this.showToast('Advertisement settings saved successfully');
        const main = document.getElementById('admin-main-view');
